...
% First occurrence: teal hyperlink; subsequent uses: black hyperlink
\definecolor{glsfirstuse}{RGB}{0,105,92}
\newif\ifglssubsequent
\renewcommand*{\glslinkcheckfirsthyperhook}{%
  \ifglsused{\glslabel}{\glssubsequenttrue}{\glssubsequentfalse}%
}
\renewcommand{\glstextformat}[1]{%
  \ifglssubsequent\textcolor{black}{#1}\else#1\fi
}
\makeglossaries
\input{acronyms}
\usepackage{multirow}
