...
% Muted color on first use to subtly mark acronym introduction
\definecolor{glsfirstuse}{RGB}{40,80,120}
\renewcommand{\glstextformat}[1]{\textcolor{glsfirstuse}{#1}}
\makeglossaries
\input{acronyms}
\usepackage{multirow}
\usepackage{lettrine}
...
% Fix list of figures/tables spacing (must be after parskip is set)
\setlength\cftbeforefigskip{-11pt}
