...
\def\Abstrakt{%
Aby ochránily své byznysově zásadní aplikace před kybernetickými hrozbami, využívají podnikové bezpečnostní týmy řadu nástrojů k detekci a řešení zranitelností ve zdrojovém kódu aplikací, konfiguraci, závislostech, CI/CD pipelines a provozní infrastruktuře. Tyto nástroje používají různé integrační vzorce, protokoly a datové formáty, což ztěžuje konzistentní analýzu, deduplikaci, třídění a seskupování jejich nálezů. Ve velkých prostředích se při propojování všech nálezů s odpovídajícími byznysovými aplikacemi objevují další výzvy. Tato práce představuje datový framework pro řešení těchto výzev a přináší tři odlišné příspěvky: (1) specifikaci požadavků na datovou platformu pro bezpečnost aplikací, (2) opakovaně použitelný a rozšiřitelný návrh zahrnující architekturu, datový model a datovou pipeline založenou na medallion architektuře a (3) Databricks MVP referenční implementaci s generovanými moduly konektorů pro devět vybraných zdrojů v různých úrovních zralosti. Společně tyto příspěvky nabízejí týmům zabývajícím se bezpečností aplikací základ pro budování robustní datové platformy nezávislé na jednotlivých dodavatelích kybernetické bezpečnosti.
}
