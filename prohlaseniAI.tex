...
\begin{itemize}
\item improvement of grammar, language style, and conciseness of the thesis, including review cycles that shortened the text by rephrasing longer passages and relocating details into the attached product documentation,
\item generation of source code for figures in the thesis,
\item generation of source code attached to the thesis (\texttt{appsec-mvp.zip}),
\item generation of product documentation attached to the thesis (\texttt{appsec-mvp-docs.zip}),
