...
The framework uses dlt (data load tool) for ingesting data from security tools into the Bronze layer. Listing~\ref{code:github-connector} shows an example connector implementation for GitHub security data.
