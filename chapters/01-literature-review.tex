...
This chapter presents the literature across three domains fundamental to this thesis. \autoref{sec:sw-dev-literature} reviews software development practices. \autoref{sec:appsec-literature} examines security testing approaches, tools, and data standards. \autoref{sec:data-literature} covers data architecture and engineering patterns. Finally, \autoref{sec:related-work} analyzes related work and identifies the gap this thesis addresses.
...
Before discussing how to secure software, it is necessary to define what modern software development entails. This section surveys the literature on software engineering practices and the \gls{sdlc}.

\subsection{Software Engineering}

\textcite{Sommerville2015} and \textcite{Pressman2019} provide comprehensive treatments of the field, covering requirements engineering, design, testing, and project management. At a more theoretical level, \textcite{Hoffman2001} collect Parnas's foundational papers on modularity and information hiding, while \textcite{Scott2015} offers a rigorous treatment of programming language design underpinning modern development tools.
