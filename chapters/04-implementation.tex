...
Databricks, but could be also other platforms

We will use \gls{dltables}, a data engineering pipeline framework running on top of Delta Lake that combines incremental ingestion, streamlined ETL, and automated data quality processes like expectations \cite{Lee2024}. The advantage of \gls{dltables} is...
